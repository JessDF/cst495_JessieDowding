...
let apiKey = "8d1b968d3b8075b564197385b9306e7a"
...
class Flickr {
    ...
    func searchFlickrForTerm(_ searchTerm: String, completion : @escaping (_ results: FlickrSearchResults?, _ error : NSError?) -> Void){
        ...
        guard let searchURL = flickrSearchURLForSearchTerm(searchTerm) else {
            let APIError = NSError(domain: "demo2UICollectionView", code: 0, userInfo: [NSLocalizedFailureReasonErrorKey:"Unknown API response"])
            ...
            do {
                ...
                case "fail":
                    if let message = resultsDictionary["message"] {
                        ...
                        let APIError = NSError(domain: "demo2UICollectionView", code: 0, userInfo: [NSLocalizedFailureReasonErrorKey:message])
                    ...
                    let APIError = NSError(domain: "demo2UICollectionView", code: 0, userInfo: nil)
